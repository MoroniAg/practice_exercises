...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    value_of_card_one = 11 if value_of_card(
        card_one) == 1 else value_of_card(card_one)
    value_of_card_two = 11 if value_of_card(
        card_two) == 1 else value_of_card(card_two)
